  ...
  <Layout>
    <section className="py-20 bg-warm/30">
      <div className="container mx-auto px-4 text-center">
        ...
        <motion.p initial="hidden" animate="visible" variants={fadeUp} custom={1} className="text-muted-foreground max-w-2xl mx-auto">Photos and videos from Dr. Lundy's events, conferences, and appearances.</motion.p>
      </div>
    </section>
    <section className="py-20 bg-background">
      <div className="container mx-auto px-4">
        <div className="flex items-center gap-2 mb-8"><Image className="w-6 h-6 text-secondary" /><h2 className="font-heading text-2xl text-primary">Photo Gallery</h2></div>
    ...
    <section className="py-20 bg-muted">
      <div className="container mx-auto px-4">
        <div className="flex items-center gap-2 mb-8"><Video className="w-6 h-6 text-secondary" /><h2 className="font-heading text-2xl text-primary">Video Gallery</h2></div>
        <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          {[1, 2].map((_, i) => (
            <motion.div key={i} initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} custom={i}
              className="bg-background rounded-xl overflow-hidden shadow-md border">
              <div className="aspect-video bg-primary/10 flex items-center justify-center"><Video className="w-12 h-12 text-muted-foreground" /></div>
              <div className="p-4">
