      ...
      <section className="py-20 bg-warm/30">
        <div className="container mx-auto px-4 text-center">
          ...
          <motion.p initial="hidden" animate="visible" variants={fadeUp} custom={1} className="text-muted-foreground max-w-2xl mx-auto">
            Get in touch with Dr. Lundy for inquiries, speaking engagements, or collaborations.
          </motion.p>
        </div>
      </section>
      <section className="py-20 bg-background">
        <div className="container mx-auto px-4">
          <motion.form
            ...
            className="max-w-xl mx-auto space-y-6 bg-card p-8 rounded-xl border shadow-md"
          >
            <div>
