    ...
    <section className="py-20 bg-warm/30">
      <div className="container mx-auto px-4 text-center">
        ...
        <motion.p initial="hidden" animate="visible" variants={fadeUp} custom={1} className="text-muted-foreground max-w-2xl mx-auto">
          Transform your leadership and personal development journey with Dr. Lundy.
        </motion.p>
      </div>
    </section>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center max-w-5xl mx-auto">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} custom={0}>
            <div className="rounded-2xl overflow-hidden shadow-xl">
              <img src={profileImg} alt="Coaching with Dr. Lundy" className="w-full h-auto" />
            </div>
          </motion.div>
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} custom={1} className="space-y-6">
            ...
            <p className="text-foreground/80 leading-relaxed">
              Dr. Lundy offers one-on-one coaching and group consultation sessions focused on 
              leadership development, academic career advancement, and personal growth strategies.
            </p>
