  ...
  <Layout>
      ...
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} custom={1}
          ...
          <div className="p-6 text-center">
            ...
            <Button variant="secondary" onClick={() => window.open("https://www.youtube.com/results?search_query=Hope+from+the+Edge+Adina+Lundy+TEDxURI", "_blank")}>
              Watch on YouTube <ArrowRight className="w-4 h-4 ml-1" />
            </Button>
          </div>
        </motion.div>
      </div>
    ...
    <section className="py-20 bg-background">
      <div className="container mx-auto px-4 max-w-3xl text-center">
        ...
        <Button variant="default" size="lg" onClick={() => window.open("https://calendly.com", "_blank")}>
